	...
	public class VRItemObjMoveHelper : MonoBehaviour
	{
		...
		private void Init(Transform objectListCanvas)
		{
			...
			if (transform != null)
			{
				...
				Sprite sprite = Sprite.Create(MaterialHelper.LoadImage("icon_call.png"), new Rect(0f, 0f, 32f, 32f), Vector2.zero);
				Sprite sprite2 = Sprite.Create(MaterialHelper.LoadImage("icon_call_xz.png"), new Rect(0f, 0f, 32f, 32f), Vector2.zero);
				if (callButton == null)
				{
				...
				{
					GameObject obj2 = Object.Instantiate(transform.gameObject);
					...
					Object.DestroyImmediate(obj2.GetComponent<Image>());
					Image image2 = obj2.AddComponent<Image>();
		...
		public void VRToggleObjectSelectOnCursor()
		{
			...
			foreach (RaycastResult item in list)
			{
				...
				{
					TreeNodeObject component = item.gameObject.transform.parent.gameObject.GetComponent<TreeNodeObject>();
